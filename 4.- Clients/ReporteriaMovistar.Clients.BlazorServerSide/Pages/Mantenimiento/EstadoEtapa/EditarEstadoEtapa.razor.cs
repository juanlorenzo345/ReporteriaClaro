...
// Info archivo:
//     Nombre: EditarEstadoEtapa.razor.cs
//     Fecha creación: 2021/11/08 at 06:28 PM
//     Fecha modificación: 2021/11/08 at 06:28 PM
// 
...
namespace ReporteriaMovistar.Clients.BlazorServerSide.Pages.Mantenimiento.EstadoEtapa
{
	public partial class EditarEstadoEtapa
	{
		private MudForm formulario;

		private UpdateEstadoEtapaModel modelo = new UpdateEstadoEtapaModel();
		...
		{
			Result<EtapaEstadoEntityDto> resultadoEstado = await this.estadoEtapaService.ObtenerEstadoPorIdAsync(Id);
			...
			EtapaEstadoEntityDto dto = resultadoEstado.Data;
		...
		public async Task GuardarAsync()
		{
			try
			{
				...
				Result resultado = await this.estadoEtapaService.ModificarEstadoAsync(modelo);
