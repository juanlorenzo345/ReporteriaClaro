...
// Info archivo:
//     Nombre: EliminarEstadoEtapa.razor.cs
...
{
	public partial class EliminarEstadoEtapa
	{
		#region Properties and Indexers

		[Parameter]
		public ViewEstadoEtapaModel Modelo
		{
			get;
			set;
		}
		...
		private async Task EliminarAsync()
		{
			try
			{
				Result resultado = await this.estadoEtapaService.EliminarEstadoAsync(
