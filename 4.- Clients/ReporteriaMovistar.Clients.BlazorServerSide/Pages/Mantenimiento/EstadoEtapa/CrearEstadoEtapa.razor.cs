...
// Info archivo:
//     Nombre: CrearEstadoEtapa.razor.cs
...
{
	public partial class CrearEstadoEtapa
	{
		private MudForm formulario;

		private NewEstadoEtapaModel modelo = new NewEstadoEtapaModel();
		...
		public async Task GuardarAsync()
		{
			try
			{
				...
				Result resultado = await this.estadoEtapaService.CrearEstadoAsync(modelo);
