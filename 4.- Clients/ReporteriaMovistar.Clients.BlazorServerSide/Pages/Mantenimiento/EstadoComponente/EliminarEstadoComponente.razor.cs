...
// Info archivo:
//     Nombre: EliminarEstadoComponente.razor.cs
...
{
	public partial class EliminarEstadoComponente
	{
		#region Properties and Indexers

		[Parameter]
		public ViewEstadoComponenteModel Modelo
		{
			get;
			set;
		}
		...
		private async Task EliminarAsync()
		{
			try
			{
				Result resultado = await this.estadoComponenteService.EliminarEstadoAsync(
