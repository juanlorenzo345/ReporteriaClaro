...
using ReporteriaClaro.Clients.ApiPowerBi.Helpers;
...
namespace ReporteriaClaro.Clients.ApiPowerBi.Middleware
{
	public class ApiAuthenticationMiddleware
	{
		...
		private readonly IDbContextFactory<ReporteriaClaroDbContext> dbContextFactory;

		private const string ApiKeyHeaderName = "ApiKey";

		public ApiAuthenticationMiddleware(RequestDelegate next, IDbContextFactory<ReporteriaClaroDbContext> dbContextFactory)
		{
			this.next = next;
