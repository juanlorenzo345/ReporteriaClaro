...
namespace ReporteriaMovistar.Application.Models.Transfer
{
    ...
    public partial class EquipoColorEntityDto
    {
        #region Constructors

        public EquipoColorEntityDto() {
        }

        public EquipoColorEntityDto(int id, string nombre, System.DateTime fechaCreacionRegistro, string usuarioCreacionRegistro, System.DateTime? fechaModificacionRegistro, string usuarioModificacionRegistro, System.DateTime? fechaEliminacionRegistro, string usuarioEliminacionRegistro, bool activo, List<EquipoEntityDto> equipoEntities) {
