...
namespace ReporteriaMovistar.Application.Models.Transfer
{
    ...
    public partial class EquipoMarcaEntityDto
    {
        #region Constructors

        public EquipoMarcaEntityDto() {
        }

        public EquipoMarcaEntityDto(int id, string nombre, System.DateTime fechaCreacionRegistro, string usuarioCreacionRegistro, System.DateTime? fechaModificacionRegistro, string usuarioModificacionRegistro, System.DateTime? fechaEliminacionRegistro, string usuarioEliminacionRegistro, bool activo, List<EquipoModeloEntityDto> equipoModeloEntities) {
