...
namespace ReporteriaClaro.Application.Models.Transfer
{
    ...
    public partial class EtapaEstadoEntityDto
    {
        #region Constructors

        public EtapaEstadoEntityDto() {
        }

        public EtapaEstadoEntityDto(int id, string nombre, int posicion, System.DateTime fechaCreacionRegistro, string usuarioCreacionRegistro, System.DateTime? fechaModificacionRegistro, string usuarioModificacionRegistro, System.DateTime? fechaEliminacionRegistro, string usuarioEliminacionRegistro, bool activo) {
