...
{
    public partial class ComponenteEstadoEntity {
        ...
        public virtual IList<EquipoEntity> EquipoEntities_FuentePoderEstadoId { get; set; }

        public virtual IList<EquipoEntity> EquipoEntities_UtpEstadoId { get; set; }

        public virtual IList<EquipoEntity> EquipoEntities_ControlRemotoEstadoId { get; set; }

        public virtual IList<EquipoEntity> EquipoEntities_HdmiEstadoId { get; set; }

        public virtual IList<EquipoEntity> EquipoEntities_RcaEstadoId { get; set; }
