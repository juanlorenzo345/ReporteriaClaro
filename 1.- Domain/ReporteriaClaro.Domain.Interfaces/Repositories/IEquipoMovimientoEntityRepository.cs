...
{
    public partial interface IEquipoMovimientoEntityRepository
    {
	    public Task<PagedResult<EquipoMovimientoEntity>> GetPaginadoAsync(string esnBuscado, int idEtapa, bool activeRecords, PagerInfo pagerInfo, SortingInfo sortingInfo);
    }
}
