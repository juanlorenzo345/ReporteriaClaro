...
{
    public partial class EquipoTecnologiaEntity {
        ...
        public virtual IList<EquipoModeloEntity> EquipoModeloEntities { get; set; }

        public virtual IList<EquipoConfiguracionEntity> EquipoConfiguracionEntities { get; set; }

        public virtual IList<PronosticoEntity> PronosticoEntities { get; set; }
