...
namespace ReporteriaMovistar.Application.Models.Transfer
{
    ...
    public static partial class EtapaEntityConverter
    {
        ...
        public static EtapaEntityDto ToDto(this ReporteriaMovistar.Domain.Models.Entities.EtapaEntity source)
        {
            return source.ToDtoWithRelated(0);
        }

        public static EtapaEntityDto ToDtoWithRelated(this ReporteriaMovistar.Domain.Models.Entities.EtapaEntity source, int level)
        {
            if (source == null)
              return null;
        ...
        public static ReporteriaMovistar.Domain.Models.Entities.EtapaEntity ToEntity(this EtapaEntityDto source)
        {
            if (source == null)
              return null;

            var target = new ReporteriaMovistar.Domain.Models.Entities.EtapaEntity();
        ...
        public static List<EtapaEntityDto> ToDtos(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.EtapaEntity> source)
        {
            if (source == null)
              return null;
        ...
        public static List<EtapaEntityDto> ToDtosWithRelated(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.EtapaEntity> source, int level)
        {
            if (source == null)
              return null;
        ...
        public static List<ReporteriaMovistar.Domain.Models.Entities.EtapaEntity> ToEntities(this IEnumerable<EtapaEntityDto> source)
        {
            if (source == null)
              return null;
        ...
        static partial void OnDtoCreating(ReporteriaMovistar.Domain.Models.Entities.EtapaEntity source, EtapaEntityDto target);

        static partial void OnEntityCreating(EtapaEntityDto source, ReporteriaMovistar.Domain.Models.Entities.EtapaEntity target);
