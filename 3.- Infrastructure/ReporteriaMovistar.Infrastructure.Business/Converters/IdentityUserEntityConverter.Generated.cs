...
namespace ReporteriaMovistar.Application.Models.Transfer
{
    ...
    public static partial class IdentityUserEntityConverter
    {
        ...
        public static IdentityUserEntityDto ToDto(this ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity source)
        {
            return source.ToDtoWithRelated(0);
        }

        public static IdentityUserEntityDto ToDtoWithRelated(this ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity source, int level)
        {
            if (source == null)
              return null;
        ...
        public static ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity ToEntity(this IdentityUserEntityDto source)
        {
            if (source == null)
              return null;

            var target = new ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity();
        ...
        public static List<IdentityUserEntityDto> ToDtos(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity> source)
        {
            if (source == null)
              return null;
        ...
        public static List<IdentityUserEntityDto> ToDtosWithRelated(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity> source, int level)
        {
            if (source == null)
              return null;
        ...
        public static List<ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity> ToEntities(this IEnumerable<IdentityUserEntityDto> source)
        {
            if (source == null)
              return null;
        ...
        static partial void OnDtoCreating(ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity source, IdentityUserEntityDto target);

        static partial void OnEntityCreating(IdentityUserEntityDto source, ReporteriaMovistar.Domain.Models.Entities.IdentityUserEntity target);
