...
namespace ReporteriaMovistar.Application.Models.Transfer
{
    ...
    public static partial class EquipoEntityConverter
    {
        ...
        public static EquipoEntityDto ToDto(this ReporteriaMovistar.Domain.Models.Entities.EquipoEntity source)
        {
            return source.ToDtoWithRelated(0);
        }

        public static EquipoEntityDto ToDtoWithRelated(this ReporteriaMovistar.Domain.Models.Entities.EquipoEntity source, int level)
        {
            if (source == null)
              return null;
        ...
        public static ReporteriaMovistar.Domain.Models.Entities.EquipoEntity ToEntity(this EquipoEntityDto source)
        {
            if (source == null)
              return null;

            var target = new ReporteriaMovistar.Domain.Models.Entities.EquipoEntity();
        ...
        public static List<EquipoEntityDto> ToDtos(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.EquipoEntity> source)
        {
            if (source == null)
              return null;
        ...
        public static List<EquipoEntityDto> ToDtosWithRelated(this IEnumerable<ReporteriaMovistar.Domain.Models.Entities.EquipoEntity> source, int level)
        {
            if (source == null)
              return null;
        ...
        public static List<ReporteriaMovistar.Domain.Models.Entities.EquipoEntity> ToEntities(this IEnumerable<EquipoEntityDto> source)
        {
            if (source == null)
              return null;
        ...
        static partial void OnDtoCreating(ReporteriaMovistar.Domain.Models.Entities.EquipoEntity source, EquipoEntityDto target);

        static partial void OnEntityCreating(EquipoEntityDto source, ReporteriaMovistar.Domain.Models.Entities.EquipoEntity target);
