...
using ReporteriaMovistar.Tasks.ApiUtilities.Services;
using Serilog;

namespace ReporteriaMovistar.Tasks.ApiUtilities
{
    class Program
    {
        ...
        static async Task<int> Main(string[] args)
         {
			...
			try
	        {
		        ...
		        Console.WriteLine("CREACIÓN DE USUARIOS PARA API REPORTERÍA MOVISTAR");
